              ...
              children:  [
                ...
                ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          //accion que permite al dar click llevar a la pagina para crear un template
                          MaterialPageRoute(builder: (context) => const CreateTemplate()),
                        );
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color.fromRGBO(0, 191, 174, 1), // Color de fondo del botón
                      ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: const ListTile(
                                title: Text('Template Name', textAlign: TextAlign.center, style: TextStyle(fontSize: 30)),
                                subtitle: Text('Connected device', textAlign: TextAlign.center, style: TextStyle(fontSize: 20))
